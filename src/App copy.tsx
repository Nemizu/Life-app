    ...
    <div>
      ...
      <div className="grid-container">
        ...
        <div className="button-container">
          <button onClick={handleAddRow} className="add-button">1列追加</button>
          <button onClick={handleAddColumn} className="add-button">1行追加</button>
          <button onClick={handleReset} className="rm-button">全マス消去</button>
          <button onClick={handleResetGridSize} className="rm-button">グリッド初期化</button>
        </div>
      </div>
    </div>
  );
